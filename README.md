...
省電力設計とEEPROMによるメッセージ保存機能を備えており、移動運用での使用に最適です。
...
## 基本動作＆操作
  各種設定操作(Mode1～3)は、スイッチがいずれの状態でも可能<br>
...
- **キー速度(WPM)変更(Mode1)**:<br>
  1.Modeボタンを1回点灯・吹鳴するまで長押し(約1秒)<br>
  2.CH1+(アップ) or CH2-(ダウン)で調整<br>
...
- **メッセージ記録(Mode2)**:<br>
  1.Modeボタンを2回点灯・吹鳴するまで長押し(約2秒)<br>
  2.CH1またはCH2ボタンを押しで、各CH記録モード<br>
  3.パドルで入力<br>
...
このプロジェクトは **GNU General Public License v3.0 (GPL v3.0)** の下で公開されています。<br>
